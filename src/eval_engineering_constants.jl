...
function get_engineering_constants_from_compliance_matrix(
    ...
    elseif size(comp_matrix)==(3,3)
        s22, s33, s44 = comp_matrix[1, 1], comp_matrix[2, 2], comp_matrix[3, 3]
        s23 = comp_matrix[1, 2]
        return Dict(
            :E22    => 1.0/s22,
            :E33    => 1.0/s33,
        ...
        @error "Invalid matrix size! $(size(comp_matrix))"
    end
end
